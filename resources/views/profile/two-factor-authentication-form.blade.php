<x-jet-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="mt-3 max-w-xl text-sm text-gray-600">
            <p>
                Quando a autenticação de dois fatores estiver ativada, você será solicitado para um token seguro e aleatório durante a autenticação. Você pode recuperar este token do aplicativo Google Authenticator do seu telefone.
            </p>
        </div>
            ...
            @if ($showingQrCode)
                <div class="mt-4 max-w-xl text-sm text-gray-600">
                    <p class="font-semibold">
                        {{ __('A autenticação de dois fatores agora está habilitada. Leia o seguinte QR-Code usando o aplicativo autenticador do seu telefone.') }}
                    </p>
                </div>
